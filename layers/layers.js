...
lyr_Google_0.setVisible(true);lyr_1975_1.setVisible(true);lyr_Brickhopu_2.setVisible(true);
var layersList = [lyr_Google_0,lyr_1975_1,lyr_Brickhopu_2];
...
lyr_Brickhopu_2.on('precompose', function(evt) {
